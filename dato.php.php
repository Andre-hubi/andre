...
fclose($f);
echo "<script type='text/javascript'>alert('Tu mensaje ha sido enviado con exito, lo atenderemos lo antes
posible. Gracias'); </script>";
echo "<script>location='contacto.html'</script> ";
}
else
{ echo '<font color="#FF0000" size="5">ERROR: </font><B>Tu mensaje no puede enviarse, debes llenar todos los
